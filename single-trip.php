                        ...
                        <div class="relative z-10">
                            ...
                            <div x-data="{ mode: 'form' }">
                                ...
                                <div x-show="mode === 'wa'" style="display: none;">
                                    ...
                                    <button onclick="window.print()" class="w-full mt-3 bg-slate-800 hover:bg-slate-700 text-white font-bold py-3 rounded-xl transition text-sm flex items-center justify-center gap-2">
